import { faBullhorn, faCircleExclamation, faCircleRadiation, faComments, faEnvelope, faFileSignature, faHouseCrack, faHouseFire, faIdCard, faPeopleRobbery, faPersonCirclePlus, faPersonWalkingArrowRight, faTruckMedical, faVideo, IconDefinition } from '@fortawesome/free-solid-svg-icons';
import { StringToNumber } from 'lodash';
import React, { createContext, useContext, ReactNode, useState } from 'react';
import { Colors } from '../../ui/types/Theme';
...
interface CoursesContextType {
  ...
  setVisibilityOfNotice : ( courseId : number, noticeId : number, visibility : boolean) => void ; 
  addMaterialToCourse: (courseId: number, directoryId: number, file: File) => void;
  ...
  updateCourseNotice : (
    courseId: number,
    noticeId: number,
    updatedNotice: { title: string; content: string; startDate: string; endDate: string }
  ) => void;
  updateCourseFile : (courseId: number, fileId: number, updatedFile: File , dirId : number) => void;
  updateCourseLecture : (courseId: number, lectureId: number, updatedLecture: Lesson) => void;
  removeStaffFromCourse: (courseId: number, staffId: number) => void;
updateStaffAccess: (courseId: number, staffId: number, newAccess: string) => void;
...
updateGroupInCourse: (courseId: number, groupId: number, updatedGroup: Group) => void;
...
export const CoursesProvider = ({ children }: CoursesProviderProps) => {
  ...
  const [fakeCourses, setFakeCourses] = useState<Course[]>([
    {
      ...
      cfu: 6,
      notices: [
        { id: 1, title : "Cambio aula per lezione di domani" ,content: 'Gentili studenti e studentesse,si comunica che, a partire dalla data di lunedì 22 aprile 2025, le lezioni del corso di [Nome del Corso] tenute dal Prof. [Cognome Docente] non si svolgeranno più nell’aula originariamente prevista (Aula [vecchia]) bensì in Aula [nuova], situata presso il [nome edificio / piano].', startDate: '2024-10-04', visible : true },
        { id: 2,  title : "Avviso" ,content: 'Lezione di Matematica sospesa per il ponte del 1 Maggio.', startDate: '2024-25-04', visible : true }
      ],
      assignments: [
        { id: 1, name: 'Laboratorio 1', date: '2024-10-04', size : 100 , student : 'S317657', mimeType : 'pdf' },
        { id: 2, name: 'Laboratorio 1', date: '2024-25-04',  size : 100 , student : 'S317658', mimeType : 'pdf'}
      ],
      staff : [
        {id : 1, name : "Tu", role: "Titolare", access : "Può eliminare"},
        {id : 2, name : "Mario Rossi", role: "Collaboratore", access : "Può leggere", idProfile : 9}
      ],
      examcalls : [
        {id : 1, name : "Matematica", date: 'Oggi', professor : "Tu" , idExam : 1},
        {id : 2, name : "Matematica", date: '2024-10-05', professor : "Tu" , idExam : 2}
      ],
      ...
      directories: [
        {
          ...
          files: [
            { id: 1, name: 'Lezione1.pdf', date :'2024-10-04', size : 100, mimeType: 'pdf', dirId : 1 },
            { id: 2, name: 'Lezione2.pdf' , date :'2024-10-04', size : 100, mimeType: 'pdf', dirId : 1}
          ]
        },
        {
          id: 2,
          name: 'Esercizi',
          files: [
            { id: 3, name: 'Esercizio1.pdf', date :'2024-10-04', size : 100 , mimeType: 'pdf', dirId : 2},
            { id: 4, name: 'Esercizio2.pdf', date :'2024-10-04', size : 100 , mimeType: 'pdf', dirId : 2}
          ]
        }
      ],
      lessons : [
        {id : 1, title : 'Lezione 1', date : '2024-10-04', time: '17:30-19:00', content : 'Spiegazione iniziale della struttura del corso. Slide da 1 a 89 del primo plico.',
          staff : [
      ...
      students: [
        { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  { id: 'S317605', name: 'Davide', surname: 'Ferrari', year: '2024', exam: 'no', cityOfBirth: 'Firenze', degreeCourse: 'Chimica', passedExams: ['Chimica Generale', 'Fisica', 'Matematica'], passedExamsDate: ['2024-01-16', '2024-02-14', '2024-03-08'] },
  { id: 'S317606', name: 'Francesca', surname: 'Gallo', year: '2024', exam: 'no', cityOfBirth: 'Bologna', degreeCourse: 'Biologia', passedExams: ['Biologia Cellulare', 'Chimica', 'Genetica'], passedExamsDate: ['2024-01-25', '2024-02-22', '2024-03-11'] },
  { id: 'S317607', name: 'Alessandro', surname: 'Russo', year: '2024', exam: 'no', cityOfBirth: 'Genova', degreeCourse: 'Economia', passedExams: ['Microeconomia', 'Statistica', 'Matematica'], passedExamsDate: ['2024-01-28', '2024-02-19', '2024-03-14'] },
  { id: 'S317608', name: 'Martina', surname: 'Greco', year: '2024', exam: 'no', cityOfBirth: 'Venezia', degreeCourse: 'Giurisprudenza', passedExams: ['Diritto Privato', 'Diritto Pubblico', 'Economia Politica'], passedExamsDate: ['2024-01-12', '2024-02-17', '2024-03-09'] },
  { id: 'S317609', name: 'Stefano', surname: 'Esposito', year: '2025', exam: 'no', cityOfBirth: 'Palermo', degreeCourse: 'Psicologia', passedExams: ['Psicologia Generale', 'Statistica', 'Psicobiologia'], passedExamsDate: ['2024-01-11', '2024-02-11', '2024-03-11'] },
  { id: 'S317610', name: 'Federica', surname: 'Romano', year: '2024', exam: 'no', cityOfBirth: 'Verona', degreeCourse: 'Sociologia', passedExams: ['Sociologia Generale', 'Metodologia', 'Statistica Sociale'], passedExamsDate: ['2024-01-15', '2024-02-20', '2024-03-13'] },
  { id: 'S317611', name: 'Matteo', surname: 'Colombo', year: '2025', exam: 'no', cityOfBirth: 'Trieste', degreeCourse: 'Filosofia', passedExams: ['Filosofia Antica', 'Logica', 'Estetica'], passedExamsDate: ['2024-01-23', '2024-02-13', '2024-03-06'] },
  { id: 'S317612', name: 'Elisa', surname: 'Conti', year: '2025', exam: 'no', cityOfBirth: 'Perugia', degreeCourse: 'Architettura', passedExams: ['Storia dell’Arte', 'Disegno Tecnico', 'Fisica'], passedExamsDate: ['2024-01-29', '2024-02-26', '2024-03-07'] },
  { id: 'S317613', name: 'Simone', surname: 'De Luca', year: '2025', exam: 'no', cityOfBirth: 'Lecce', degreeCourse: 'Informatica', passedExams: ['Programmazione', 'Matematica Discreta', 'Sistemi Operativi'], passedExamsDate: ['2024-01-19', '2024-02-21', '2024-03-18'] },
  { id: 'S317614', name: 'Valentina', surname: 'Barbieri', year: '2024', exam: 'no', cityOfBirth: 'Cagliari', degreeCourse: 'Design', passedExams: ['Disegno Industriale', 'Teoria del Colore', 'Storia del Design'], passedExamsDate: ['2024-01-14', '2024-02-23', '2024-03-20'] },
  { id: 'S317615', name: 'Andrea', surname: 'Mancini', year: '2024', exam: 'si', cityOfBirth: 'Modena', degreeCourse: 'Economia', passedExams: ['Microeconomia', 'Macroeconomia', 'Statistica'], passedExamsDate: ['2024-01-09', '2024-02-05', '2024-03-04'] },
  { id: 'S317616', name: 'Sara', surname: 'Moretti', year: '2024', exam: 'si', cityOfBirth: 'Parma', degreeCourse: 'Biotecnologie', passedExams: ['Biologia Molecolare', 'Chimica', 'Bioinformatica'], passedExamsDate: ['2024-01-26', '2024-02-16', '2024-03-17'] },
  { id: 'S317617', name: 'Gabriele', surname: 'Fontana', year: '2025', exam: 'si', cityOfBirth: 'Reggio Emilia', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi I', 'Informatica'], passedExamsDate: ['2024-01-13', '2024-02-08', '2024-03-16'] },
  { id: 'S317618', name: 'Ilaria', surname: 'Mariani', year: '2024', exam: 'si', cityOfBirth: 'Aosta', degreeCourse: 'Lingue', passedExams: ['Lingua Inglese', 'Linguistica', 'Letteratura'], passedExamsDate: ['2024-01-27', '2024-02-10', '2024-03-19'] },
  { id: 'S317619', name: 'Nicola', surname: 'Rinaldi', year: '2025', exam: 'si', cityOfBirth: 'Trento', degreeCourse: 'Statistica', passedExams: ['Statistica I', 'Probabilità', 'Economia'], passedExamsDate: ['2024-01-17', '2024-02-25', '2024-03-03'] },
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
      ],
      groups: [
  {
    id: 1,
  ...
  },
  {
    ...
    },
    {
      ...
      examcalls : [
        {id : 1, name : "Fisica", date: '2024-10-04', professor : "Tu" , idExam : 3},
        {id : 2, name : "Fisica", date: '2024-10-05', professor : "Tu" , idExam : 4}
      ],
      guide: "this is the course guide",
      directories: [
        {
      ...
      lessons : [
        {id : 1, title : 'Lezione 1', date : '2024-10-04', time: '17:00-18:30', content : 'ciao a tutti voi'}
      ],
       students : [
            { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    },
    {
      ...
      cfu: 9,
      notices: [
        { id: 1,  title : "Avviso" ,content: 'Nuove esercitazioni caricate sulla piattaforma.', startDate: '2024-30-03' , visible : true}
      ],
      assignments: [
      ...
      examcalls : [
        {id : 1, name : "Programmazione", date: '2024-04-10', professor : "Tu" , idExam : 5},
        {id : 2, name : "Programmazione", date: '2024-05-10', professor : "Tu" , idExam : 6}
      ],
      guide: "this is the course guide",
      directories: [
        {
          ...
          name: 'Appunti Lezioni',
          files: [
            { id: 1, name: 'Lezione1.pdf', date :'2024-04-10', size : 100 , mimeType: 'pdf', dirId : 1},
            { id: 2, name: 'Lezione2.pdf' , date :'2024-04-10', size : 100, mimeType: 'pdf', dirId : 1}
          ]
        },
        {
          id: 2,
          name: 'Esercizi',
          files: [
            { id: 3, name: 'Esercizio1.pdf' , date :'2024-04-10', size : 100, mimeType: 'pdf', dirId : 2},
            { id: 4, name: 'Esercizio2.pdf', date :'2024-04-10', size : 100, mimeType: 'pdf', dirId : 2 }
          ]
        }
      ],
      lessons : [
        {id : 1, title : 'Lezione 1', date : '2024-04-10', time: '17:30-19:00', content : 'ciao a tutti voi'}
      ],
      students : [
           { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    },
    {
      ...
      cfu: 6,
      notices: [
        { id: 1,  title : "Avviso" ,content: 'Aggiornamenti sul laboratorio di Chimica disponibili.', startDate: '2024-04-01' , visible : true}
      ],
      assignments: [
      ...
      examcalls : [
        {id : 1, name : "Chimica", date: '2024-10-04', professor : "Tu" , idExam : 7},
        {id : 2, name : "Chimica", date: '2024-10-05', professor : "Tu" , idExam : 8}
      ],
      guide: "this is the course guide",
      directories: [
        {
      ...
      lessons : [
        {id : 1, title : 'Lezione 1', date : '2024-10-04', time: '17:30-19:00', content : 'ciao a tutti voi'}
      ],
      students : [
           { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  ...
  const [managedCourses, setManagedCourses] = useState<Course[]>([
    {
      ...
      cfu: 6,
      notices: [
        { id: 1,  title : "Avviso" ,content: 'Rinviato il test di Informatica Teorica.', startDate: '2024-03-28', visible : true }
      ],
      assignments: [
      ...
      staff : [
        ...
        {id : 2, name : "Mario Rossi", role: "Titolare", access : "Può leggere", idProfile : 9}
      ],
      examcalls : [
        {id : 1, name : "Informatica Teorica", date: '2024-10-04', professor : "Tu" , idExam : 9},
        {id : 2, name : "Informatica Teorica", date: '2024-10-05', professor : "Tu" , idExam : 10}
      ],
      guide: "this is the course guide",
      directories: [
        {
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    },
    {
      ...
      notices: [
        { id: 1, title : "Avviso" , content: 'Prolungato il termine per la consegna del progetto.', startDate: '2024-02-04' , visible : true}
      ],
      assignments: [
      ...
      examcalls : [
        {id : 1, name : "Intelligenza Artificiale", date: '2024-10-04', professor : "Tu" , idExam : 11},
        {id : 2, name : "Intelligenza Artificiale", date: '2024-10-05', professor : "Tu" , idExam : 12}
      ],
      guide: "this is the course guide",
      directories: [
        {
  ...
  const [fakeExams, setFakeExams] = useState<Exam[]>([
    { id: 1, subject: 'Matematica', date: 'Oggi', endDate : 'Chiuse' , period : 1, where: 'Aula 3', modality: 'Scritto', booked : 89 ,   students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 2, subject: 'Matematica', date: '2025-10-05', endDate : '2025-30-04' , period : 2, where: 'Aula 3', modality: 'Scritto', booked : 89 ,   students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 3, subject: 'Fisica', date: '2025-20-04',  endDate : '2025-10-04' , period : 1,  where: 'Aula 3', modality: 'Scritto' , booked : 89,   students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
     ...
     { id: 4, subject: 'Fisica', date: '2025-20-05',  endDate : '2025-10-05' , period : 2,  where: 'Aula 3', modality: 'Scritto' , booked : 89,   students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 5, subject: 'Programmazione', date: '2025-20-04', endDate : '2025-10-04' ,  period : 1 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 6, subject: 'Programmazione', date: '2025-20-05', endDate : '2025-10-05' ,  period : 2 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 7, subject: 'Chimica', date: '2025-20-04', endDate : '2025-10-04' ,  period : 1 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
               { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 8, subject: 'Chimica', date: '2025-20-05', endDate : '2025-10-05' ,  period : 2 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
               { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 9, subject: 'Informatica Teorica', date: '2025-20-04', endDate : '2025-10-04' ,  period : 1 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
               { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 10, subject: 'Informatica Teorica', date: '2025-20-05', endDate : '2025-10-05' ,  period : 2 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 11, subject: 'Intelligenza Artificiale', date: '2025-20-04', endDate : '2025-10-04' ,  period : 1 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
               { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
  ...
  { id: 'S317620', name: 'Laura', surname: 'Fabbri', year: '2024', exam: 'si', cityOfBirth: 'Rimini', degreeCourse: 'Medicina', passedExams: ['Anatomia', 'Fisiologia', 'Biologia'], passedExamsDate: ['2024-01-21', '2024-02-15', '2024-03-01'] }
    ...
    { id: 12, subject: 'Intelligenza Artificiale', date: '2025-20-05', endDate : '2025-10-05' ,  period : 2 , where: 'Aula 3', modality: 'Scritto' , booked : 89  , students: [
                { id: 'S317601', name: 'Luca', surname: 'Bianchi', year: '2024', exam: 'no', cityOfBirth: 'Milano', degreeCourse: 'Informatica', passedExams: ['Matematica I', 'Programmazione', 'Fisica I'], passedExamsDate: ['2024-01-10', '2024-02-12', '2024-03-05'] },
  { id: 'S317602', name: 'Giulia', surname: 'Rossi', year: '2024', exam: 'no', cityOfBirth: 'Roma', degreeCourse: 'Fisica', passedExams: ['Fisica I', 'Analisi I', 'Laboratorio'], passedExamsDate: ['2024-01-18', '2024-02-20', '2024-03-15'] },
  { id: 'S317603', name: 'Marco', surname: 'Verdi', year: '2024', exam: 'no', cityOfBirth: 'Torino', degreeCourse: 'Matematica', passedExams: ['Analisi I', 'Algebra', 'Geometria'], passedExamsDate: ['2024-01-22', '2024-02-28', '2024-03-10'] },
  { id: 'S317604', name: 'Chiara', surname: 'Neri', year: '2024', exam: 'no', cityOfBirth: 'Napoli', degreeCourse: 'Ingegneria', passedExams: ['Fisica I', 'Analisi', 'Meccanica'], passedExamsDate: ['2024-01-30', '2024-02-18', '2024-03-12'] },
...
const addStudentsToExam = (examId: number, newStudents: Student[]) => {
  setFakeExams(prevExams =>
    prevExams.map(exam => {
      ...
      const existingStudentIds = new Set(exam.students.map(student => student.id));
      const uniqueNewStudents = newStudents.filter(student => !existingStudentIds.has(student.id));
  ...
  if (selectedExam && selectedExam.id === examId) {
    const existingStudentIds = new Set(selectedExam.students.map(student => student.id));
    const uniqueNewStudents = newStudents.filter(student => !existingStudentIds.has(student.id));
  ...
  const [services, setServices] = useState<Service[]>([
    { id: 'Mail', name: 'Mail', icon: faEnvelope, linkTo: 'Mail', favorite: true },
    { id: 'People', name: 'Persone', icon: faIdCard, linkTo: 'Persone', favorite: true },
    { id: 'DigitalSignature', name:t('other.digitalSignature') , icon: faFileSignature, linkTo: 'DigitalSignature', favorite: false },
    { id: 'Segnalations', name: t('other.reportsFault') , icon: faComments, linkTo: 'IssueReport', favorite: false },
    { id: 'News', name: t('newsScreen.title') , icon: faBullhorn, linkTo: 'News', favorite: false },
    { id: 'BookingPlaces', name: t('other.bookPlaces') , icon: faPersonCirclePlus, linkTo: 'Prenotazione', favorite: false },
    { id: 'Emergency', name: t('other.emergencies'), icon: faCircleExclamation, linkTo: 'Emergency', favorite: false },
    { id: 'Support', name: t('other.support'), icon: faVideo, linkTo: 'Supporto', favorite: false },
  ]);
  ...
  const [agendaItems, setAgendaItems] = useState<AgendaItem[]>([
    {id :0, title: 'Fisica', description: 'Meccanica e Termodinamica', time: '10:00 - 11:30', date: '2025-05-11', type: 'lezione' , location : 'Aula 2'},
        {id :1, title: 'Fisica', description: 'Meccanica e Termodinamica', time: '10:00 - 13:00', date: '2025-06-05', type: 'lezione' , location : 'Aula 2'},
        {id :2, title: 'Matematica', description: 'Analisi e Algebra', time: '08:30 - 10:00', date: '2025-06-05',  type: 'lezione', location : 'Aula 2' },
        {id :3, title: 'Programmazione', description: 'Strutture dati', time:'11:30 - 13:00', date: '2025-06-06',  type: 'lezione' , location : 'Aula 2'},
        {id :4, title: 'Chimica', description: 'Composti organici', time:  '08:30 - 10:00', date: '2025-06-07',  type: 'lezione' , location : 'Aula 2'},
        {id :5, title: 'Informatica Teorica', description: 'Automi e linguaggi', time: '08:30 - 10:00', date: '2025-06-08', type: 'lezione', location : 'Aula 2' },
        {id :6, title: 'Matematica', description: 'Analisi e Algebra', time: '10:00 - 11:30', date: '2025-06-09',  type: 'lezione', location : 'Aula 2'},
       
        {id :7, title: 'Fisica', description: 'Meccanica e Termodinamica', time: '10:00 - 11:30', date: '2025-06-12',type: 'lezione', location : 'Aula 2'},
        {id :8, title: 'Matematica', description: 'Analisi e Algebra', time: '08:30 - 10:00', date: '2025-06-12',  type: 'lezione', location : 'Aula 2'},
        {id :9, title: 'Programmazione', description: 'Strutture dati', time:'11:30 - 13:00', date: '2025-06-14',type: 'lezione', location : 'Aula 2' },
        {id :10, title: 'Chimica', description: 'Composti organici', time:  '08:30 - 10:00', date: '2025-06-15',  type: 'lezione', location : 'Aula 2'},
        {id :11, title: 'Informatica Teorica', description: 'Automi e linguaggi', time:  '08:30 - 10:00', date: '2025-06-16', type: 'lezione', location : 'Aula 2'},
        {id :12, title: 'Matematica', description: 'Analisi e Algebra', time: '10:00 - 11:30', date: '2025-06-16',  type: 'lezione' , location : 'Aula 2'},
    
        {id :13, title: 'Matematica', description: 'Analisi e Algebra', time:'08:30 - 10:00', date: '2025-06-19', type: 'lezione', location : 'Aula 2'},
        {id :14, title: 'Fisica', description: 'Meccanica e Termodinamica', time: '10:00 - 11:30', date: '2025-06-19',  type: 'lezione', location : 'Aula 2'},
        {id :15, title: 'Programmazione', description: 'Strutture dati', time:'11:30 - 13:00', date: '2025-06-21',  type: 'lezione', location : 'Aula 2'},
        {id :16, title: 'Chimica', description: 'Composti organici', time: '08:30 - 10:00', date: '2025-06-22', type: 'lezione' , location : 'Aula 2'},
        {id :17, title: 'Informatica Teorica', description: 'Automi e linguaggi', time: '08:30 - 10:00', date: '2025-06-23', type: 'lezione', location : 'Aula 2' },
        {id :18, title: 'Matematica', description: 'Analisi e Algebra', time: '10:00 - 11:30', date: '2025-06-23', type: 'lezione', location : 'Aula 2' },
    
        {id :19, title: 'Matematica', description: 'Analisi e Algebra', time: '08:30 - 10:00', date: '2025-06-26', type: 'lezione', location : 'Aula 2' },
        {id :20, title: 'Fisica', description: 'Meccanica e Termodinamica', time:'10:00 - 11:30', date: '2025-06-26',  type: 'lezione', location : 'Aula 2'},
        {id :21, title: 'Programmazione', description: 'Strutture dati', time: '11:30 - 13:00', date: '2025-06-28', type: 'lezione' , location : 'Aula 2'},
        {id :22, title: 'Chimica', description: 'Composti organici', time:  '08:30 - 10:00', date: '2025-06-29',  type: 'lezione', location : 'Aula 2'},
        {id :23, title: 'Informatica Teorica', description: 'Automi e linguaggi', time: '08:30 - 10:00', date: '2025-06-30',  type: 'lezione', location : 'Aula 2'},
        {id :24, title: 'Matematica', description: 'Analisi e Algebra', time: '10:00 - 11:30', date: '2025-06-30',  type: 'lezione' , location : 'Aula 2'},
      ]
  );
...
const [fakeProfiles, setFakeProfiles] = useState<Profile[]>([
  ...
  },
  {
    ...
    role: "Profesore Associato",
    role2: "Vice coordinatore collegio di ingegneria informatica, del cinema e meccatronica",
  ...
  },
  {
    ...
    collaboratingCourses: ["Architettura Sostenibile", "Tecnologia delle Costruzioni"],
    preferred: false,
    publications: [
 ...
 sector: "INF/01 - Informatica",
  ...
  const addLesson = (courseId: number, lesson: Lesson) => {
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      setSelectedCourse(prevSelectedCourse =>
        prevSelectedCourse
          ? { ...prevSelectedCourse, lessons: [...(prevSelectedCourse.lessons || []), lesson] }
          : prevSelectedCourse
      );
    }
  };
  ...
  const addStaffToCourse = (courseId: number, newStaff: Staff[]) => {
    setFakeCourses(prevCourses =>
      prevCourses.map(course => {
        ...
        const uniqueNewStaff = newStaff.filter(member => !existingStaffIds.has(member.id));
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      const existingStaffIds = new Set(selectedCourse.staff.map(member => member.id));
      const uniqueNewStaff = newStaff.filter(member => !existingStaffIds.has(member.id));
  
      setSelectedCourse(prev =>
        prev
          ? { ...prev, staff: [...prev.staff, ...uniqueNewStaff] }
          : prev
      );
    }
  };
  ...
  setFakeCourses(prevCourses =>
    prevCourses.map(course => {
      ...
      const existingStudentIds = new Set(course.students.map(student => student.id));
      const uniqueNewStudents = newStudents.filter(student => !existingStudentIds.has(student.id));
  ...
  if (selectedCourse && selectedCourse.id === courseId) {
    const existingStudentIds = new Set(selectedCourse.students.map(student => student.id));
    const uniqueNewStudents = newStudents.filter(student => !existingStudentIds.has(student.id));
  ...
  console.log("Adding notice to course", notice);
  ...
  const deleteNoticeFromCourse = (courseId: number, noticeId: number) => {
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      setSelectedCourse(prevSelectedCourse =>
        prevSelectedCourse
          ? { ...prevSelectedCourse, notices: prevSelectedCourse.notices.filter(notice => notice.id !== noticeId) }
          : prevSelectedCourse
      );
    }
  };
  ...
  const addMaterialToCourse = (courseId: number, directoryId: number, file: File) => {
    setFakeCourses(prevCourses =>
      prevCourses.map(course =>
        course.id === courseId
          ? {
...
const getProfileById = (idProfile: number): Profile | undefined => {
  ...
  const setVisibilityOfNotice = (courseId: number, noticeId: number, visibility: boolean) => {
    setFakeCourses(prevCourses =>
      prevCourses.map(course =>
        course.id === courseId
          ? {
              ...
              notices: course.notices.map(notice =>
                notice.id === noticeId ? { ...notice, visible: visibility } : notice
              )
            }
          : course
      )
  ...
  const addGroupToCourse = (courseId: number, newGroup: Group) => {
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      setSelectedCourse(prevSelectedCourse =>
        prevSelectedCourse
          ? { ...prevSelectedCourse, groups: [...prevSelectedCourse.groups || [], newGroup] }
          : prevSelectedCourse
      );
    }
  };
  ...
  const removeGroupFromCourse = (courseId: number, groupId: number) => {
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      setSelectedCourse(prevSelectedCourse =>
        prevSelectedCourse
          ? { ...prevSelectedCourse, groups: prevSelectedCourse.groups?.filter(group => group.id !== groupId) }
          : prevSelectedCourse
      );
    }
  };
  const updateGroupInCourse = (courseId: number, groupId: number, updatedGroup: Group) => {
    setFakeCourses(prevCourses =>
      prevCourses.map(course =>
        course.id === courseId
          ? {
  ...
  const removeAssignmentFromCourse = (courseId: number, assignmentId: number) => {
    setFakeCourses(prevCourses =>
      prevCourses.map(course =>
        course.id === courseId
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      setSelectedCourse(prevSelectedCourse =>
        prevSelectedCourse
          ? { ...prevSelectedCourse, assignments: prevSelectedCourse.assignments.filter(assignment => assignment.id !== assignmentId) }
          : prevSelectedCourse
      );
    }
  };
  ...
  const deleteLessonFromCourse = (courseId: number, lessonId: number) => {
    ...
    setSelectedCourse(prevCourse =>
      prevCourse?.id === courseId
        ? {
            ...prevCourse,
            lessons: prevCourse.lessons?.filter(lesson => lesson.id !== lessonId) // Rimuove la lezione dal corso selezionato
          }
        : prevCourse
    );
  };
  ...
  const updateCourseFile = (courseId: number, fileId: number, updatedFile: File, newDirectoryId: number) => {
    setFakeCourses(prevCourses =>
      prevCourses.map(course => {
        ...
        const updatedDirectories = course.directories.map(directory => {
          if (directory.files.some(file => file.id === fileId)) {
            fileToMove = directory.files.find(file => file.id === fileId) || null;
            return {
              ...directory,
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      setSelectedCourse(prevSelectedCourse => {
        ...
        let fileToMove: File | null = null;
        const updatedDirectories = prevSelectedCourse.directories.map(directory => {
          if (directory.files.some(file => file.id === fileId)) {
            fileToMove = directory.files.find(file => file.id === fileId) || null;
            return {
              ...directory,
  ...
  const updateCourseLecture = (courseId: number, lectureId: number, updatedLecture: Lesson) => {
...
const removeStaffFromCourse = (courseId: number, staffId: number) => {
  setFakeCourses(prevCourses => {
    const updatedCourses = prevCourses.map(course =>
      course.id === courseId
        ? { ...course, staff: course.staff.filter(member => member.id !== staffId) }
        : course
    );

    // Aggiorna selectedCourse se è quello attuale
    const updatedSelectedCourse = updatedCourses.find(c => c.id === courseId) || null;
  ...
  const updateStaffAccess = (courseId: number, staffId: number, newAccess: string) => {
    setFakeCourses(prevCourses =>
      prevCourses.map(course =>
        course.id === courseId
          ? {
              ...
              staff: course.staff.map(member =>
                member.id === staffId ? { ...member, access: newAccess } : member
              )
            }
          : course
      )
    ...
    if (selectedStaff && selectedStaff.id === staffId) {
      setSelectedStaff(prev =>
        prev ? { ...prev, access: newAccess } : prev
      );
    }
  };
    ...
    setFakeCourses(prevCourses =>
      prevCourses.map(course =>
        course.id === courseId
          ? {
              ...course,
              directories: course.directories.filter(dir => dir.id !== directoryId),
            }
          : course
      )
    );
    ...
    if (selectedCourse && selectedCourse.id === courseId) {
      setSelectedCourse(prevSelectedCourse =>
        prevSelectedCourse
          ? {
              ...prevSelectedCourse,
              directories: prevSelectedCourse.directories.filter(dir => dir.id !== directoryId),
            }
          : prevSelectedCourse
      );
    }
