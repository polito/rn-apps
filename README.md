...
- the shared library `@polito/lib` (core logic, UI components, feature modules)
- the `base` React Native app
- the `students` app
- the `faculty` app

## Talk with us

Feel free to [open an issue](https://github.com/polito/rn-apps/issues/new/choose) if:
...
The issues of more general interest and wide impact will be converted to open [Discussions](https://github.com/polito/rn-apps/discussions), where we seek input and feedback from the whole community. You are encouraged to comment and contribute to currently open Discussions.

## Roadmap and feature proposals

We use GitHub [Projects](https://github.com/orgs/polito/projects/2) to keep track of the roadmap.  
If you would like to propose a new feature, feel free to open an [issue](https://github.com/polito/rn-apps/issues/new) with the Feature Proposal template.

## Repository structure

- [lib](lib)
  - Shared library (`@polito/lib`) with core logic, UI primitives and feature modules used across apps.
- [base](base)
...
## If you build a customized or modified version of this Apps
