...
export const LoginScreen = () => {
  ...
  const canLogin = Boolean(username.length && password.length);
            ...
            <Row align="center">
              ...
              <IconButton
                ...
                accessibilityLabel={t(
                  `loginScreen.${passwordVisible ? 'hidePassword' : 'showPassword'}`,
                )}
...
const createStyles = ({ spacing, fontSizes }: Theme) =>
  StyleSheet.create({
    ...
    textFieldInput: {
      flex: 1,
      paddingHorizontal: Platform.select({ android: spacing[4] }),
    },
    link: {
      alignItems: 'flex-end',
