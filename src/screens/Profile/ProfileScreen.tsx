      ...
      headerRight: () => (
        <Row>
          ...
          <IconButton
            ...
            onPress={() => navigation.navigate('Profile_form')}
          />
      ...
      bounces={false}>
        ...
        <SectionList>
          <ListItem
            ...
            leadingItem={
              <Icon icon={faHome} size={fontSizes['xl']} />
            }></ListItem>
          <ListItem
          ...
          <ListItem
            ...
            subtitle={user.IBAN}
            leadingItem={
              <Icon icon={faBank} size={fontSizes['xl']} />
            }></ListItem>
        </SectionList>
        <View style={{paddingBottom: spacing[5]}}></View>
        ...
        <SectionList>
          <ListItem
            ...
            subtitle={user.phone}
            leadingItem={
              <Icon icon={faPhone} size={fontSizes['xl']} />
            }></ListItem>
          <ListItem
            title={'Email'}
            subtitle={user.email}
            leadingItem={
              <Icon icon={faEnvelope} size={fontSizes['xl']} />
            }></ListItem>
          <ListItem
...
<SectionList>
          <ListItem
            ...
            leadingItem={
              <Icon icon={faGear} size={fontSizes['xl']} />
            }
